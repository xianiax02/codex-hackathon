...
| 17:20–진행 중 | 발표 세션에서 확정한 실제 학원 휴원 사례를 demo에 반영 | 문제를 `자녀 교육 결정을 직접 전달하지 못해 가족·번역기에 의존하는 순간`으로 고정하고, 휴원 시작·기간→일시 휴원 확인→재연락 시점의 3-turn fixture와 API contract·UI 문구를 동기화 | API 8건, state/pitch 6건, JSON 2건, empty audio 422 smoke와 실제 `/api/context` 응답으로 확인 | 실제 경험에서 나온 `다음 달부터 두 달 동안…언제 연락해야 하나요?` 문장과 사회문제 framing을 확정 |
